...
git clone <https://github.com/hyperpolymath/poly-k8s-mcp.git> cd
poly-k8s-mcp
...
toolbox create poly-k8s-mcp-dev toolbox enter poly-k8s-mcp-dev \#
...
poly-k8s-mcp/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/poly-k8s-mcp/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/poly-k8s-mcp/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/poly-k8s-mcp/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/poly-k8s-mcp/labels/perimeter-3) — Community sandbox scope
